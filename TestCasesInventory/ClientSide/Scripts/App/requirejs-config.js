...
requirejs.config({
    ...
    'paths': {
        ...
        'testRunResultByStatusShowChart': 'App/TestRunResult/HighCharts/test-run-result-high-chart',
        'testRunResultByTesterShowChart': 'App/TestRunResult/HighCharts/test-run-result-run-by-high-chart',
